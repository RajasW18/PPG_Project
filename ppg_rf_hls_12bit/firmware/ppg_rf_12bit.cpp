...
#include "ppg_rf_12bit.h"

void ppg_rf_12bit(input_arr_t x, score_arr_t score){
...
void ppg_rf_12bit_accelerator(int N, int& n_f, int& n_c, accelerator_input_t* x, accelerator_output_t* score){
  n_f = n_features;
